...
/**
 * This class stands for GetCustomizableDaysChanges StructType
 * @subpackage Structs
 */
class GetCustomizableDaysChanges extends AbstractStructBase
{
    /**
     * The driverID
    ...
    /**
     * Constructor method for GetCustomizableDaysChanges
     * @uses GetCustomizableDaysChanges::setDriverID()
     ...
     * Set driverID value
     * @param string $driverID
     * @return \StructType\GetCustomizableDaysChanges
     */
