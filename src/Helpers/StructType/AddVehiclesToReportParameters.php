...
/**
 * This class stands for AddVehiclesToReportParameters StructType
 * @subpackage Structs
 */
class AddVehiclesToReportParameters extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for AddVehiclesToReportParameters
     * @uses AddVehiclesToReportParameters::setReportId()
     * @uses AddVehiclesToReportParameters::setVehicleIds()
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\AddVehiclesToReportParameters
     */
