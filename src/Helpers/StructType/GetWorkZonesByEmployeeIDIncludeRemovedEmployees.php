...
/**
 * This class stands for GetWorkZonesByEmployeeIDIncludeRemovedEmployees StructType
 * @subpackage Structs
 */
class GetWorkZonesByEmployeeIDIncludeRemovedEmployees extends AbstractStructBase
{
    /**
     * The employeeID
    ...
    /**
     * Constructor method for GetWorkZonesByEmployeeIDIncludeRemovedEmployees
     * @uses GetWorkZonesByEmployeeIDIncludeRemovedEmployees::setEmployeeID()
     * @uses GetWorkZonesByEmployeeIDIncludeRemovedEmployees::setPageNumber()
     * @uses GetWorkZonesByEmployeeIDIncludeRemovedEmployees::setPageSize()
     * @uses GetWorkZonesByEmployeeIDIncludeRemovedEmployees::setSortedColumn()
     * @uses GetWorkZonesByEmployeeIDIncludeRemovedEmployees::setSortOrder()
     * @uses GetWorkZonesByEmployeeIDIncludeRemovedEmployees::setWorkZonesOwner()
     * @uses GetWorkZonesByEmployeeIDIncludeRemovedEmployees::setIncludeRemovedEmployees()
     ...
     */
    public function __construct(?string $employeeID = null, ?int $pageNumber = null, ?int $pageSize = null, ?string $sortedColumn = null, ?string $sortOrder = null, ?string $workZonesOwner = null, ?bool $includeRemovedEmployees = null)
    {
        $this
     ...
     * @param string $employeeID
     * @return \StructType\GetWorkZonesByEmployeeIDIncludeRemovedEmployees
     */
