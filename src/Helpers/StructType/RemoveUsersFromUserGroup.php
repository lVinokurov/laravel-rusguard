...
/**
 * This class stands for RemoveUsersFromUserGroup StructType
 * @subpackage Structs
 */
class RemoveUsersFromUserGroup extends AbstractStructBase
{
    /**
     * The userGroupID
    ...
    /**
     * Constructor method for RemoveUsersFromUserGroup
     * @uses RemoveUsersFromUserGroup::setUserGroupID()
     * @uses RemoveUsersFromUserGroup::setUserIDs()
     ...
     * @param string $userGroupID
     * @return \StructType\RemoveUsersFromUserGroup
     */
