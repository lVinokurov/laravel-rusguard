...
/**
 * This class stands for BroadcastFindBasIpDevices StructType
 * @subpackage Structs
 */
class BroadcastFindBasIpDevices extends AbstractStructBase
{
    /**
     * The deviceServerId
    ...
    /**
     * Constructor method for BroadcastFindBasIpDevices
     * @uses BroadcastFindBasIpDevices::setDeviceServerId()
     ...
     * @param string $deviceServerId
     * @return \StructType\BroadcastFindBasIpDevices
     */
