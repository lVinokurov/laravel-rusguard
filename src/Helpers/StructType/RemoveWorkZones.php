...
/**
 * This class stands for RemoveWorkZones StructType
 * @subpackage Structs
 */
class RemoveWorkZones extends AbstractStructBase
{
    /**
     * The ids
    ...
    /**
     * Constructor method for RemoveWorkZones
     * @uses RemoveWorkZones::setIds()
     ...
     * @param \ArrayType\ArrayOfguid $ids
     * @return \StructType\RemoveWorkZones
     */
