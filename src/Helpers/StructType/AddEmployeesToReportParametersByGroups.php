...
/**
 * This class stands for AddEmployeesToReportParametersByGroups StructType
 * @subpackage Structs
 */
class AddEmployeesToReportParametersByGroups extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for AddEmployeesToReportParametersByGroups
     * @uses AddEmployeesToReportParametersByGroups::setReportId()
     * @uses AddEmployeesToReportParametersByGroups::setEmployeeGroupIds()
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\AddEmployeesToReportParametersByGroups
     */
