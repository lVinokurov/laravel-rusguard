...
/**
 * This class stands for SaveMap StructType
 * @subpackage Structs
 */
class SaveMap extends AbstractStructBase
{
    /**
     * The id
    ...
    /**
     * Constructor method for SaveMap
     * @uses SaveMap::setId()
     * @uses SaveMap::setData()
     * @param string $id
     * @param \StructType\MapSaveData $data
     */
    public function __construct(?string $id = null, ?\StructType\MapSaveData $data = null)
    {
        $this
            ->setId($id)
            ->setData($data);
