...
/**
 * This class stands for RemoveDriversFromReportParameters StructType
 * @subpackage Structs
 */
class RemoveDriversFromReportParameters extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for RemoveDriversFromReportParameters
     * @uses RemoveDriversFromReportParameters::setReportId()
     * @uses RemoveDriversFromReportParameters::setDriverIds()
     * @param string $reportId
     * @param \ArrayType\ArrayOfguid $driverIds
     */
    public function __construct(?string $reportId = null, ?\ArrayType\ArrayOfguid $driverIds = null)
    {
        $this
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\RemoveDriversFromReportParameters
     */
