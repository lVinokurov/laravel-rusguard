...
/**
 * This class stands for SetDevicesAddressBySidViaCanConverter StructType
 * @subpackage Structs
 */
class SetDevicesAddressBySidViaCanConverter extends AbstractStructBase
{
    /**
     * The deviceServerId
    ...
    /**
     * Constructor method for SetDevicesAddressBySidViaCanConverter
     * @uses SetDevicesAddressBySidViaCanConverter::setDeviceServerId()
     * @uses SetDevicesAddressBySidViaCanConverter::setDevices()
     ...
     * @param string $deviceServerId
     * @return \StructType\SetDevicesAddressBySidViaCanConverter
     */
