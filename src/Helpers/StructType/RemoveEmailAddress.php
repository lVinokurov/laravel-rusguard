...
/**
 * This class stands for RemoveEmailAddress StructType
 * @subpackage Structs
 */
class RemoveEmailAddress extends AbstractStructBase
{
    /**
     * The ids
    ...
    /**
     * Constructor method for RemoveEmailAddress
     * @uses RemoveEmailAddress::setIds()
     * @uses RemoveEmailAddress::setPartOfCreateOperation()
     ...
     * @param \ArrayType\ArrayOfguid $ids
     * @return \StructType\RemoveEmailAddress
     */
