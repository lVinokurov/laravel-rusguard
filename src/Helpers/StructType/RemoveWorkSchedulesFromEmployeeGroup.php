...
/**
 * This class stands for RemoveWorkSchedulesFromEmployeeGroup StructType
 * @subpackage Structs
 */
class RemoveWorkSchedulesFromEmployeeGroup extends AbstractStructBase
{
    /**
     * The employeeGroupID
    ...
    /**
     * Constructor method for RemoveWorkSchedulesFromEmployeeGroup
     * @uses RemoveWorkSchedulesFromEmployeeGroup::setEmployeeGroupID()
     * @uses RemoveWorkSchedulesFromEmployeeGroup::setWorkScheduleIDs()
     ...
     * @param string $employeeGroupID
     * @return \StructType\RemoveWorkSchedulesFromEmployeeGroup
     */
