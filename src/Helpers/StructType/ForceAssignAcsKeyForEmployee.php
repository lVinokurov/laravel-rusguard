...
/**
 * This class stands for ForceAssignAcsKeyForEmployee StructType
 * @subpackage Structs
 */
class ForceAssignAcsKeyForEmployee extends AbstractStructBase
{
    /**
     * The employeeId
    ...
    /**
     * Constructor method for ForceAssignAcsKeyForEmployee
     * @uses ForceAssignAcsKeyForEmployee::setEmployeeId()
     * @uses ForceAssignAcsKeyForEmployee::setIndexNumber()
     * @uses ForceAssignAcsKeyForEmployee::setKeyData()
     * @uses ForceAssignAcsKeyForEmployee::setPartOfCreateOperation()
     ...
     * @param string $employeeId
     * @return \StructType\ForceAssignAcsKeyForEmployee
     */
