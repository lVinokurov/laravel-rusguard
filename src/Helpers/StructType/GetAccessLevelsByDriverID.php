...
/**
 * This class stands for GetAccessLevelsByDriverID StructType
 * @subpackage Structs
 */
class GetAccessLevelsByDriverID extends AbstractStructBase
{
    /**
     * The driverID
    ...
    /**
     * Constructor method for GetAccessLevelsByDriverID
     * @uses GetAccessLevelsByDriverID::setDriverID()
     ...
     * Set driverID value
     * @param string $driverID
     * @return \StructType\GetAccessLevelsByDriverID
     */
