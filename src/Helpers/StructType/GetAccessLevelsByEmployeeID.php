...
/**
 * This class stands for GetAccessLevelsByEmployeeID StructType
 * @subpackage Structs
 */
class GetAccessLevelsByEmployeeID extends AbstractStructBase
{
    /**
     * The employeeID
    ...
    /**
     * Constructor method for GetAccessLevelsByEmployeeID
     * @uses GetAccessLevelsByEmployeeID::setEmployeeID()
     * @uses GetAccessLevelsByEmployeeID::setPageNumber()
     * @uses GetAccessLevelsByEmployeeID::setPageSize()
     * @uses GetAccessLevelsByEmployeeID::setSortedColumn()
     * @uses GetAccessLevelsByEmployeeID::setSortOrder()
     * @uses GetAccessLevelsByEmployeeID::setAccessLevelsOwner()
     ...
     */
    public function __construct(?string $employeeID = null, ?int $pageNumber = null, ?int $pageSize = null, ?string $sortedColumn = null, ?string $sortOrder = null, ?string $accessLevelsOwner = null)
    {
        $this
     ...
     * @param string $employeeID
     * @return \StructType\GetAccessLevelsByEmployeeID
     */
