...
/**
 * This class stands for OwnerListValue StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:OwnerListValue
 * @subpackage Structs
 */
class OwnerListValue extends OwnerValueBase
{
    /**
     * The Value
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for OwnerListValue
     * @uses OwnerListValue::setValue()
     ...
     * @param \StructType\ListItem $value
     * @return \StructType\OwnerListValue
     */
