...
/**
 * This class stands for DeletePhotoFields StructType
 * @subpackage Structs
 */
class DeletePhotoFields extends AbstractStructBase
{
    /**
     * The ids
    ...
    /**
     * Constructor method for DeletePhotoFields
     * @uses DeletePhotoFields::setIds()
     ...
     * @param \ArrayType\ArrayOfguid $ids
     * @return \StructType\DeletePhotoFields
     */
