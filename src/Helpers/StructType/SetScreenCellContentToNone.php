...
/**
 * This class stands for SetScreenCellContentToNone StructType
 * @subpackage Structs
 */
class SetScreenCellContentToNone extends AbstractStructBase
{
    /**
     * The cellId
    ...
    /**
     * Constructor method for SetScreenCellContentToNone
     * @uses SetScreenCellContentToNone::setCellId()
     * @param string $cellId
     */
     ...
     * Set cellId value
     * @param string $cellId
     * @return \StructType\SetScreenCellContentToNone
     */
