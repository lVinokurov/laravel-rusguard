...
/**
 * This class stands for AddEmployeesToSecurityGroup StructType
 * @subpackage Structs
 */
class AddEmployeesToSecurityGroup extends AbstractStructBase
{
    /**
     * The securityGroup
    ...
    /**
     * Constructor method for AddEmployeesToSecurityGroup
     * @uses AddEmployeesToSecurityGroup::setSecurityGroup()
     * @uses AddEmployeesToSecurityGroup::setEmployeeIds()
     ...
     * @param string $securityGroup
     * @return \StructType\AddEmployeesToSecurityGroup
     */
