...
/**
 * This class stands for AddAccessLevelsToEmployeeForce StructType
 * @subpackage Structs
 */
class AddAccessLevelsToEmployeeForce extends AbstractStructBase
{
    /**
     * The employeeID
    ...
    /**
     * Constructor method for AddAccessLevelsToEmployeeForce
     * @uses AddAccessLevelsToEmployeeForce::setEmployeeID()
     * @uses AddAccessLevelsToEmployeeForce::setAccessLevelInfo()
     ...
     * @param string $employeeID
     * @return \StructType\AddAccessLevelsToEmployeeForce
     */
