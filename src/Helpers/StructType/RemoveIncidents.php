...
/**
 * This class stands for RemoveIncidents StructType
 * @subpackage Structs
 */
class RemoveIncidents extends AbstractStructBase
{
    /**
     * The ids
    ...
    /**
     * Constructor method for RemoveIncidents
     * @uses RemoveIncidents::setIds()
     ...
     * @param \ArrayType\ArrayOfguid $ids
     * @return \StructType\RemoveIncidents
     */
