...
/**
 * This class stands for GetPhotoidentificationPersonalData StructType
 * @subpackage Structs
 */
class GetPhotoidentificationPersonalData extends AbstractStructBase
{
    /**
     * The cellId
    ...
    /**
     * Constructor method for GetPhotoidentificationPersonalData
     * @uses GetPhotoidentificationPersonalData::setCellId()
     * @param string $cellId
     */
     ...
     * Set cellId value
     * @param string $cellId
     * @return \StructType\GetPhotoidentificationPersonalData
     */
