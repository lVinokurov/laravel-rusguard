...
/**
 * This class stands for AddLogMessageSubtypesToReportParameters StructType
 * @subpackage Structs
 */
class AddLogMessageSubtypesToReportParameters extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for AddLogMessageSubtypesToReportParameters
     * @uses AddLogMessageSubtypesToReportParameters::setReportId()
     * @uses AddLogMessageSubtypesToReportParameters::setSubtypes()
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\AddLogMessageSubtypesToReportParameters
     */
