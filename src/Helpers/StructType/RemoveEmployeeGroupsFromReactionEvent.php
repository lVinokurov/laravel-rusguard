...
/**
 * This class stands for RemoveEmployeeGroupsFromReactionEvent StructType
 * @subpackage Structs
 */
class RemoveEmployeeGroupsFromReactionEvent extends AbstractStructBase
{
    /**
     * The eventId
    ...
    /**
     * Constructor method for RemoveEmployeeGroupsFromReactionEvent
     * @uses RemoveEmployeeGroupsFromReactionEvent::setEventId()
     * @uses RemoveEmployeeGroupsFromReactionEvent::setEmployeeGroupIds()
     ...
     * Set eventId value
     * @param string $eventId
     * @return \StructType\RemoveEmployeeGroupsFromReactionEvent
     */
