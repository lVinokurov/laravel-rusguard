...
/**
 * This class stands for RemoveAccessLevelFromEmployee StructType
 * @subpackage Structs
 */
class RemoveAccessLevelFromEmployee extends AbstractStructBase
{
    /**
     * The employeeID
    ...
    /**
     * Constructor method for RemoveAccessLevelFromEmployee
     * @uses RemoveAccessLevelFromEmployee::setEmployeeID()
     * @uses RemoveAccessLevelFromEmployee::setAccessLevelIDs()
     ...
     * @param string $employeeID
     * @return \StructType\RemoveAccessLevelFromEmployee
     */
