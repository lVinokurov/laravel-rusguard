...
/**
 * This class stands for GetBranchOfReportParameters StructType
 * @subpackage Structs
 */
class GetBranchOfReportParameters extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for GetBranchOfReportParameters
     * @uses GetBranchOfReportParameters::setReportId()
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\GetBranchOfReportParameters
     */
