...
/**
 * This class stands for GetEmployeeGroupsForAlcoGroup StructType
 * @subpackage Structs
 */
class GetEmployeeGroupsForAlcoGroup extends AbstractStructBase
{
    /**
     * The groupID
    ...
    /**
     * Constructor method for GetEmployeeGroupsForAlcoGroup
     * @uses GetEmployeeGroupsForAlcoGroup::setGroupID()
     ...
     * Set groupID value
     * @param string $groupID
     * @return \StructType\GetEmployeeGroupsForAlcoGroup
     */
