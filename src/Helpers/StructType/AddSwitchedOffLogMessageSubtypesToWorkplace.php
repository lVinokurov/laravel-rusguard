...
/**
 * This class stands for AddSwitchedOffLogMessageSubtypesToWorkplace StructType
 * @subpackage Structs
 */
class AddSwitchedOffLogMessageSubtypesToWorkplace extends AbstractStructBase
{
    /**
     * The workplaceId
    ...
    /**
     * Constructor method for AddSwitchedOffLogMessageSubtypesToWorkplace
     * @uses AddSwitchedOffLogMessageSubtypesToWorkplace::setWorkplaceId()
     * @uses AddSwitchedOffLogMessageSubtypesToWorkplace::setSubtypes()
     ...
     * @param string $workplaceId
     * @return \StructType\AddSwitchedOffLogMessageSubtypesToWorkplace
     */
