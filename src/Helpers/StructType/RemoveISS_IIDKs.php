...
/**
 * This class stands for RemoveISS_IIDKs StructType
 * @subpackage Structs
 */
class RemoveISS_IIDKs extends AbstractStructBase
{
    /**
     * The ids
    ...
    /**
     * Constructor method for RemoveISS_IIDKs
     * @uses RemoveISS_IIDKs::setIds()
     ...
     * @param \ArrayType\ArrayOfguid $ids
     * @return \StructType\RemoveISS_IIDKs
     */
