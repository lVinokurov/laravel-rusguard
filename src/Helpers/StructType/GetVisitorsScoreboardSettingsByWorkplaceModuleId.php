...
/**
 * This class stands for GetVisitorsScoreboardSettingsByWorkplaceModuleId
 * StructType
 * @subpackage Structs
 */
class GetVisitorsScoreboardSettingsByWorkplaceModuleId extends AbstractStructBase
{
    /**
     * The moduleId
    ...
    /**
     * Constructor method for GetVisitorsScoreboardSettingsByWorkplaceModuleId
     * @uses GetVisitorsScoreboardSettingsByWorkplaceModuleId::setModuleId()
     ...
     * Set moduleId value
     * @param string $moduleId
     * @return \StructType\GetVisitorsScoreboardSettingsByWorkplaceModuleId
     */
