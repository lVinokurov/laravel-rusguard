...
/**
 * This class stands for GetScreenLayoutForWorkplaceModule StructType
 * @subpackage Structs
 */
class GetScreenLayoutForWorkplaceModule extends AbstractStructBase
{
    /**
     * The moduleId
    ...
    /**
     * Constructor method for GetScreenLayoutForWorkplaceModule
     * @uses GetScreenLayoutForWorkplaceModule::setModuleId()
     ...
     * Set moduleId value
     * @param string $moduleId
     * @return \StructType\GetScreenLayoutForWorkplaceModule
     */
