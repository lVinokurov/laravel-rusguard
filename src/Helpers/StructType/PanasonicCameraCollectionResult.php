...
/**
 * This class stands for PanasonicCameraCollectionResult StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:PanasonicCameraCollectionResult
 * @subpackage Structs
 */
class PanasonicCameraCollectionResult extends AbstractStructBase
{
    /**
     * The DriverFullInfo
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for PanasonicCameraCollectionResult
     * @uses PanasonicCameraCollectionResult::setDriverFullInfo()
     ...
     * @param \ArrayType\ArrayOfLDriverFullInfo $driverFullInfo
     * @return \StructType\PanasonicCameraCollectionResult
     */
