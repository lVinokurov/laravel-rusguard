...
/**
 * This class stands for RemoveEmployeeFromReportParametersByGroups StructType
 * @subpackage Structs
 */
class RemoveEmployeeFromReportParametersByGroups extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for RemoveEmployeeFromReportParametersByGroups
     * @uses RemoveEmployeeFromReportParametersByGroups::setReportId()
     * @uses RemoveEmployeeFromReportParametersByGroups::setEmployeeGroupIds()
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\RemoveEmployeeFromReportParametersByGroups
     */
