...
/**
 * This class stands for AlcoGroupChangePriority StructType
 * @subpackage Structs
 */
class AlcoGroupChangePriority extends AbstractStructBase
{
    /**
     * The ids
    ...
    /**
     * Constructor method for AlcoGroupChangePriority
     * @uses AlcoGroupChangePriority::setIds()
     ...
     * @param \ArrayType\ArrayOfguid $ids
     * @return \StructType\AlcoGroupChangePriority
     */
