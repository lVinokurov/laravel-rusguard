...
/**
 * This class stands for SetAdditionalColorValue StructType
 * @subpackage Structs
 */
class SetAdditionalColorValue extends AbstractStructBase
{
    /**
     * The ownerId
    ...
    /**
     * Constructor method for SetAdditionalColorValue
     * @uses SetAdditionalColorValue::setOwnerId()
     * @uses SetAdditionalColorValue::setFieldId()
     * @uses SetAdditionalColorValue::setValue()
     * @uses SetAdditionalColorValue::setPartOfCreateOperation()
     * @uses SetAdditionalColorValue::setSavedFieldContext()
     ...
     * Set ownerId value
     * @param string $ownerId
     * @return \StructType\SetAdditionalColorValue
     */
    ...
    public static function validateSavedFieldContextForArrayConstraintsFromSetSavedFieldContext(array $values = []): string
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $setAdditionalColorValueSavedFieldContextItem) {
            // validation for constraint: enumeration
            if (!\EnumType\SavedFieldContext::valueIsValid($setAdditionalColorValueSavedFieldContextItem)) {
                $invalidValues[] = is_object($setAdditionalColorValueSavedFieldContextItem) ? get_class($setAdditionalColorValueSavedFieldContextItem) : sprintf('%s(%s)', gettype($setAdditionalColorValueSavedFieldContextItem), var_export($setAdditionalColorValueSavedFieldContextItem, true));
            }
        }
