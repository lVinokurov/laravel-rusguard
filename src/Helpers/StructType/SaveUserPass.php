...
/**
 * This class stands for SaveUserPass StructType
 * @subpackage Structs
 */
class SaveUserPass extends AbstractStructBase
{
    /**
     * The id
    ...
    /**
     * Constructor method for SaveUserPass
     * @uses SaveUserPass::setId()
     * @uses SaveUserPass::setData()
     * @param string $id
     * @param \StructType\UserPassSlimSaveData $data
     */
    public function __construct(?string $id = null, ?\StructType\UserPassSlimSaveData $data = null)
    {
        $this
            ->setId($id)
            ->setData($data);
     ...
     * Set id value
     * @param string $id
     * @return \StructType\SaveUserPass
     */
