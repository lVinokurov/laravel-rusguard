...
/**
 * This class stands for AddEmployeeGroupsToReactionEvent StructType
 * @subpackage Structs
 */
class AddEmployeeGroupsToReactionEvent extends AbstractStructBase
{
    /**
     * The eventId
    ...
    /**
     * Constructor method for AddEmployeeGroupsToReactionEvent
     * @uses AddEmployeeGroupsToReactionEvent::setEventId()
     * @uses AddEmployeeGroupsToReactionEvent::setEmployeeGroupIds()
     ...
     * Set eventId value
     * @param string $eventId
     * @return \StructType\AddEmployeeGroupsToReactionEvent
     */
