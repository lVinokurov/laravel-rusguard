...
/**
 * This class stands for SaveWorkZone StructType
 * @subpackage Structs
 */
class SaveWorkZone extends AbstractStructBase
{
    /**
     * The id
    ...
    /**
     * Constructor method for SaveWorkZone
     * @uses SaveWorkZone::setId()
     * @uses SaveWorkZone::setData()
     * @param string $id
     * @param \StructType\WorkZoneSlimSaveData $data
     */
    public function __construct(?string $id = null, ?\StructType\WorkZoneSlimSaveData $data = null)
    {
        $this
            ->setId($id)
            ->setData($data);
     ...
     * Set id value
     * @param string $id
     * @return \StructType\SaveWorkZone
     */
