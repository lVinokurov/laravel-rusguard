...
/**
 * This class stands for SetAdditionalListValue StructType
 * @subpackage Structs
 */
class SetAdditionalListValue extends AbstractStructBase
{
    /**
     * The ownerId
    ...
    /**
     * Constructor method for SetAdditionalListValue
     * @uses SetAdditionalListValue::setOwnerId()
     * @uses SetAdditionalListValue::setFieldId()
     * @uses SetAdditionalListValue::setValue()
     * @uses SetAdditionalListValue::setPartOfCreateOperation()
     * @uses SetAdditionalListValue::setSavedFieldContext()
     ...
     */
    public function __construct(?string $ownerId = null, ?string $fieldId = null, ?\StructType\ListItem $value = null, ?bool $partOfCreateOperation = null, $savedFieldContext = [])
    {
        $this
            ->setOwnerId($ownerId)
            ->setFieldId($fieldId)
     ...
     * Set ownerId value
     * @param string $ownerId
     * @return \StructType\SetAdditionalListValue
     */
    ...
    public static function validateSavedFieldContextForArrayConstraintsFromSetSavedFieldContext(array $values = []): string
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $setAdditionalListValueSavedFieldContextItem) {
            // validation for constraint: enumeration
            if (!\EnumType\SavedFieldContext::valueIsValid($setAdditionalListValueSavedFieldContextItem)) {
                $invalidValues[] = is_object($setAdditionalListValueSavedFieldContextItem) ? get_class($setAdditionalListValueSavedFieldContextItem) : sprintf('%s(%s)', gettype($setAdditionalListValueSavedFieldContextItem), var_export($setAdditionalListValueSavedFieldContextItem, true));
            }
        }
