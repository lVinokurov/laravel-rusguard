...
/**
 * This class stands for GetAcsKeysForEmployee StructType
 * @subpackage Structs
 */
class GetAcsKeysForEmployee extends AbstractStructBase
{
    /**
     * The employeeId
    ...
    /**
     * Constructor method for GetAcsKeysForEmployee
     * @uses GetAcsKeysForEmployee::setEmployeeId()
     ...
     * @param string $employeeId
     * @return \StructType\GetAcsKeysForEmployee
     */
