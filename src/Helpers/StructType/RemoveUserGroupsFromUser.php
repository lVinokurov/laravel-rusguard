...
/**
 * This class stands for RemoveUserGroupsFromUser StructType
 * @subpackage Structs
 */
class RemoveUserGroupsFromUser extends AbstractStructBase
{
    /**
     * The userID
    ...
    /**
     * Constructor method for RemoveUserGroupsFromUser
     * @uses RemoveUserGroupsFromUser::setUserID()
     * @uses RemoveUserGroupsFromUser::setUserGroupIDs()
     * @param string $userID
     ...
     * Set userID value
     * @param string $userID
     * @return \StructType\RemoveUserGroupsFromUser
     */
