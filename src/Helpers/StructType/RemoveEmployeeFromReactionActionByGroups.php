...
/**
 * This class stands for RemoveEmployeeFromReactionActionByGroups StructType
 * @subpackage Structs
 */
class RemoveEmployeeFromReactionActionByGroups extends AbstractStructBase
{
    /**
     * The actionId
    ...
    /**
     * Constructor method for RemoveEmployeeFromReactionActionByGroups
     * @uses RemoveEmployeeFromReactionActionByGroups::setActionId()
     * @uses RemoveEmployeeFromReactionActionByGroups::setEmployeeGroupIds()
     ...
     * Set actionId value
     * @param string $actionId
     * @return \StructType\RemoveEmployeeFromReactionActionByGroups
     */
