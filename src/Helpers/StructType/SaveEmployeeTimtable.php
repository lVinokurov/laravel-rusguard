...
/**
 * This class stands for SaveEmployeeTimtable StructType
 * @subpackage Structs
 */
class SaveEmployeeTimtable extends AbstractStructBase
{
    /**
     * The employeeID
    ...
    /**
     * Constructor method for SaveEmployeeTimtable
     * @uses SaveEmployeeTimtable::setEmployeeID()
     * @uses SaveEmployeeTimtable::setData()
     * @uses SaveEmployeeTimtable::setPartOfCreateOperation()
     * @param string $employeeID
     * @param \ArrayType\ArrayOfWorkTimetableSlimInfo $data
     * @param bool $partOfCreateOperation
     */
    public function __construct(?string $employeeID = null, ?\ArrayType\ArrayOfWorkTimetableSlimInfo $data = null, ?bool $partOfCreateOperation = null)
    {
        $this
     ...
     * @param string $employeeID
     * @return \StructType\SaveEmployeeTimtable
     */
