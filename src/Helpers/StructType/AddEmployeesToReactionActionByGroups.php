...
/**
 * This class stands for AddEmployeesToReactionActionByGroups StructType
 * @subpackage Structs
 */
class AddEmployeesToReactionActionByGroups extends AbstractStructBase
{
    /**
     * The actionId
    ...
    /**
     * Constructor method for AddEmployeesToReactionActionByGroups
     * @uses AddEmployeesToReactionActionByGroups::setActionId()
     * @uses AddEmployeesToReactionActionByGroups::setEmployeeGroupIds()
     ...
     * Set actionId value
     * @param string $actionId
     * @return \StructType\AddEmployeesToReactionActionByGroups
     */
