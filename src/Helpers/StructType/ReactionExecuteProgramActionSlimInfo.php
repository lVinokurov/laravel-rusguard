...
/**
 * This class stands for ReactionExecuteProgramActionSlimInfo StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:ReactionExecuteProgramActionSlimInfo
 * @subpackage Structs
 */
class ReactionExecuteProgramActionSlimInfo extends ReactionExecuteProgramActionSaveData
{
    /**
     * The CommonData
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for ReactionExecuteProgramActionSlimInfo
     * @uses ReactionExecuteProgramActionSlimInfo::setCommonData()
     ...
     * @param \StructType\ReactionActionSlimInfo $commonData
     * @return \StructType\ReactionExecuteProgramActionSlimInfo
     */
