...
/**
 * This class stands for GetEmailAddressesIncludeRemovedEmployees StructType
 * @subpackage Structs
 */
class GetEmailAddressesIncludeRemovedEmployees extends AbstractStructBase
{
    /**
     * The owner
    ...
    /**
     * Constructor method for GetEmailAddressesIncludeRemovedEmployees
     * @uses GetEmailAddressesIncludeRemovedEmployees::setOwner()
     * @uses GetEmailAddressesIncludeRemovedEmployees::setOwnerId()
     * @uses GetEmailAddressesIncludeRemovedEmployees::setIncludeRemovedEmployees()
     * @param string $owner
     ...
     * @param string $owner
     * @return \StructType\GetEmailAddressesIncludeRemovedEmployees
     */
