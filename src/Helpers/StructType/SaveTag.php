...
/**
 * This class stands for SaveTag StructType
 * @subpackage Structs
 */
class SaveTag extends AbstractStructBase
{
    /**
     * The id
    ...
    /**
     * Constructor method for SaveTag
     * @uses SaveTag::setId()
     * @uses SaveTag::setData()
     * @param string $id
     * @param \StructType\TagSaveData $data
     */
    public function __construct(?string $id = null, ?\StructType\TagSaveData $data = null)
    {
        $this
            ->setId($id)
            ->setData($data);
