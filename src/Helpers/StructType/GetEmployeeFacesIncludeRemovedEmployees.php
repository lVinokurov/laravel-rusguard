...
/**
 * This class stands for GetEmployeeFacesIncludeRemovedEmployees StructType
 * @subpackage Structs
 */
class GetEmployeeFacesIncludeRemovedEmployees extends AbstractStructBase
{
    /**
     * The employeeId
    ...
    /**
     * Constructor method for GetEmployeeFacesIncludeRemovedEmployees
     * @uses GetEmployeeFacesIncludeRemovedEmployees::setEmployeeId()
     * @uses GetEmployeeFacesIncludeRemovedEmployees::setIncludeRemovedEmployees()
     ...
     * @param string $employeeId
     * @return \StructType\GetEmployeeFacesIncludeRemovedEmployees
     */
