...
/**
 * This class stands for GetVehicleForEmployeeIncludeRemovedEmployees StructType
 * @subpackage Structs
 */
class GetVehicleForEmployeeIncludeRemovedEmployees extends AbstractStructBase
{
    /**
     * The employeeId
    ...
    /**
     * Constructor method for GetVehicleForEmployeeIncludeRemovedEmployees
     * @uses GetVehicleForEmployeeIncludeRemovedEmployees::setEmployeeId()
     * @uses GetVehicleForEmployeeIncludeRemovedEmployees::setIncludeRemovedEmployees()
     * @param string $employeeId
     * @param bool $includeRemovedEmployees
     */
    public function __construct(?string $employeeId = null, ?bool $includeRemovedEmployees = null)
    {
        $this
     ...
     * @param string $employeeId
     * @return \StructType\GetVehicleForEmployeeIncludeRemovedEmployees
     */
