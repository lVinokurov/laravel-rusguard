...
/**
 * This class stands for AddFavoriteFolderByWorplace StructType
 * @subpackage Structs
 */
class AddFavoriteFolderByWorplace extends AbstractStructBase
{
    /**
     * The data
    ...
    /**
     * Constructor method for AddFavoriteFolderByWorplace
     * @uses AddFavoriteFolderByWorplace::setData()
     ...
     * @param \StructType\FavoriteFolderSaveData $data
     * @return \StructType\AddFavoriteFolderByWorplace
     */
