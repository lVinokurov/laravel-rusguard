...
/**
 * This class stands for GetEmployeeGroupsOfReportParameters StructType
 * @subpackage Structs
 */
class GetEmployeeGroupsOfReportParameters extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for GetEmployeeGroupsOfReportParameters
     * @uses GetEmployeeGroupsOfReportParameters::setReportId()
     * @uses GetEmployeeGroupsOfReportParameters::setIsShowRemoved()
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\GetEmployeeGroupsOfReportParameters
     */
