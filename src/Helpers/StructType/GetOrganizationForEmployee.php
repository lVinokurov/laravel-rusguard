...
/**
 * This class stands for GetOrganizationForEmployee StructType
 * @subpackage Structs
 */
class GetOrganizationForEmployee extends AbstractStructBase
{
    /**
     * The employeeId
    ...
    /**
     * Constructor method for GetOrganizationForEmployee
     * @uses GetOrganizationForEmployee::setEmployeeId()
     ...
     * @param string $employeeId
     * @return \StructType\GetOrganizationForEmployee
     */
