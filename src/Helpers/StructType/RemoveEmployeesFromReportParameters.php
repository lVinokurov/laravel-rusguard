...
/**
 * This class stands for RemoveEmployeesFromReportParameters StructType
 * @subpackage Structs
 */
class RemoveEmployeesFromReportParameters extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for RemoveEmployeesFromReportParameters
     * @uses RemoveEmployeesFromReportParameters::setReportId()
     * @uses RemoveEmployeesFromReportParameters::setEmployeeIds()
     * @param string $reportId
     * @param \ArrayType\ArrayOfguid $employeeIds
     */
    public function __construct(?string $reportId = null, ?\ArrayType\ArrayOfguid $employeeIds = null)
    {
        $this
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\RemoveEmployeesFromReportParameters
     */
