...
/**
 * This class stands for SaveAcsWorkDayWithTransfer StructType
 * @subpackage Structs
 */
class SaveAcsWorkDayWithTransfer extends AbstractStructBase
{
    /**
     * The id
    ...
    /**
     * Constructor method for SaveAcsWorkDayWithTransfer
     * @uses SaveAcsWorkDayWithTransfer::setId()
     * @uses SaveAcsWorkDayWithTransfer::setName()
     * @uses SaveAcsWorkDayWithTransfer::setDate()
     * @uses SaveAcsWorkDayWithTransfer::setTransferedDate()
     * @param string $id
     * @param string $name
     * @param string $date
     * @param string $transferedDate
     */
    public function __construct(?string $id = null, ?string $name = null, ?string $date = null, ?string $transferedDate = null)
    {
        $this
            ->setId($id)
            ->setName($name)
     ...
     * Set id value
     * @param string $id
     * @return \StructType\SaveAcsWorkDayWithTransfer
     */
