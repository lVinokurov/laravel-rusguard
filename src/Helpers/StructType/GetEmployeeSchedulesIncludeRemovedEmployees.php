...
/**
 * This class stands for GetEmployeeSchedulesIncludeRemovedEmployees StructType
 * @subpackage Structs
 */
class GetEmployeeSchedulesIncludeRemovedEmployees extends AbstractStructBase
{
    /**
     * The employeeId
    ...
    /**
     * Constructor method for GetEmployeeSchedulesIncludeRemovedEmployees
     * @uses GetEmployeeSchedulesIncludeRemovedEmployees::setEmployeeId()
     * @uses GetEmployeeSchedulesIncludeRemovedEmployees::setIncludeRemovedEmployees()
     ...
     * @param string $employeeId
     * @return \StructType\GetEmployeeSchedulesIncludeRemovedEmployees
     */
