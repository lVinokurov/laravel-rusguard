...
/**
 * This class stands for DeleteFields StructType
 * @subpackage Structs
 */
class DeleteFields extends AbstractStructBase
{
    /**
     * The ids
    ...
    /**
     * Constructor method for DeleteFields
     * @uses DeleteFields::setIds()
     ...
     * @param \ArrayType\ArrayOfguid $ids
     * @return \StructType\DeleteFields
     */
