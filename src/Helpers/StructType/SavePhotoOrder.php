...
/**
 * This class stands for SavePhotoOrder StructType
 * @subpackage Structs
 */
class SavePhotoOrder extends AbstractStructBase
{
    /**
     * The photoOrder
    ...
    /**
     * Constructor method for SavePhotoOrder
     * @uses SavePhotoOrder::setPhotoOrder()
     ...
     * @param \StructType\PhotoOrder $photoOrder
     * @return \StructType\SavePhotoOrder
     */
