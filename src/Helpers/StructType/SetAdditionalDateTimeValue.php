...
/**
 * This class stands for SetAdditionalDateTimeValue StructType
 * @subpackage Structs
 */
class SetAdditionalDateTimeValue extends AbstractStructBase
{
    /**
     * The ownerId
    ...
    /**
     * Constructor method for SetAdditionalDateTimeValue
     * @uses SetAdditionalDateTimeValue::setOwnerId()
     * @uses SetAdditionalDateTimeValue::setFieldId()
     * @uses SetAdditionalDateTimeValue::setValue()
     * @uses SetAdditionalDateTimeValue::setPartOfCreateOperation()
     * @uses SetAdditionalDateTimeValue::setSavedFieldContext()
     ...
     * Set ownerId value
     * @param string $ownerId
     * @return \StructType\SetAdditionalDateTimeValue
     */
    ...
    public static function validateSavedFieldContextForArrayConstraintsFromSetSavedFieldContext(array $values = []): string
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $setAdditionalDateTimeValueSavedFieldContextItem) {
            // validation for constraint: enumeration
            if (!\EnumType\SavedFieldContext::valueIsValid($setAdditionalDateTimeValueSavedFieldContextItem)) {
                $invalidValues[] = is_object($setAdditionalDateTimeValueSavedFieldContextItem) ? get_class($setAdditionalDateTimeValueSavedFieldContextItem) : sprintf('%s(%s)', gettype($setAdditionalDateTimeValueSavedFieldContextItem), var_export($setAdditionalDateTimeValueSavedFieldContextItem, true));
            }
        }
