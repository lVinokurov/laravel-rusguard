...
/**
 * This class stands for Add_ISS_Driver StructType
 * @subpackage Structs
 */
class Add_ISS_Driver extends AbstractStructBase
{
    /**
     * The data
    ...
    /**
     * Constructor method for Add_ISS_Driver
     * @uses Add_ISS_Driver::setData()
     * @param \StructType\ISS_Driver_SaveData $data
     */
    public function __construct(?\StructType\ISS_Driver_SaveData $data = null)
    {
        $this
            ->setData($data);
    }
     ...
     * @param \StructType\ISS_Driver_SaveData $data
     * @return \StructType\Add_ISS_Driver
     */
