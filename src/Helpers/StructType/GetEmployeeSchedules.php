...
/**
 * This class stands for GetEmployeeSchedules StructType
 * @subpackage Structs
 */
class GetEmployeeSchedules extends AbstractStructBase
{
    /**
     * The employeeId
    ...
    /**
     * Constructor method for GetEmployeeSchedules
     * @uses GetEmployeeSchedules::setEmployeeId()
     ...
     * @param string $employeeId
     * @return \StructType\GetEmployeeSchedules
     */
