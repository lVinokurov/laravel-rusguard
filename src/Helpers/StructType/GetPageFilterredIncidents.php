...
/**
 * This class stands for GetPageFilterredIncidents StructType
 * @subpackage Structs
 */
class GetPageFilterredIncidents extends AbstractStructBase
{
    /**
     * The pageNumber
    ...
    /**
     * Constructor method for GetPageFilterredIncidents
     * @uses GetPageFilterredIncidents::setPageNumber()
     * @uses GetPageFilterredIncidents::setPageSize()
     * @uses GetPageFilterredIncidents::setSortedColumn()
     * @uses GetPageFilterredIncidents::setSortOrder()
     * @uses GetPageFilterredIncidents::setFilter()
     * @uses GetPageFilterredIncidents::setOnlyCount()
     ...
     */
    public function __construct(?int $pageNumber = null, ?int $pageSize = null, ?string $sortedColumn = null, ?string $sortOrder = null, ?\StructType\IncidentsFilter $filter = null, ?bool $onlyCount = null)
    {
        $this
     ...
     * @param int $pageNumber
     * @return \StructType\GetPageFilterredIncidents
     */
