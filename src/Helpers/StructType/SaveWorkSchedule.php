...
/**
 * This class stands for SaveWorkSchedule StructType
 * @subpackage Structs
 */
class SaveWorkSchedule extends AbstractStructBase
{
    /**
     * The id
    ...
    /**
     * Constructor method for SaveWorkSchedule
     * @uses SaveWorkSchedule::setId()
     * @uses SaveWorkSchedule::setData()
     * @param string $id
     * @param \StructType\WorkScheduleSlimSaveData $data
     */
    public function __construct(?string $id = null, ?\StructType\WorkScheduleSlimSaveData $data = null)
    {
        $this
            ->setId($id)
            ->setData($data);
     ...
     * Set id value
     * @param string $id
     * @return \StructType\SaveWorkSchedule
     */
