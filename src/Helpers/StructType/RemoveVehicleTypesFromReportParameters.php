...
/**
 * This class stands for RemoveVehicleTypesFromReportParameters StructType
 * @subpackage Structs
 */
class RemoveVehicleTypesFromReportParameters extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for RemoveVehicleTypesFromReportParameters
     * @uses RemoveVehicleTypesFromReportParameters::setReportId()
     * @uses RemoveVehicleTypesFromReportParameters::setVehicleIds()
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\RemoveVehicleTypesFromReportParameters
     */
