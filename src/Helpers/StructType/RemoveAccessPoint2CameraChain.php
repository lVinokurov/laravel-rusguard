...
/**
 * This class stands for RemoveAccessPoint2CameraChain StructType
 * @subpackage Structs
 */
class RemoveAccessPoint2CameraChain extends AbstractStructBase
{
    /**
     * The ids
    ...
    /**
     * Constructor method for RemoveAccessPoint2CameraChain
     * @uses RemoveAccessPoint2CameraChain::setIds()
     ...
     * @param \ArrayType\ArrayOfguid $ids
     * @return \StructType\RemoveAccessPoint2CameraChain
     */
