...
/**
 * This class stands for RemoveNetworkToSubnetworkLink StructType
 * @subpackage Structs
 */
class RemoveNetworkToSubnetworkLink extends AbstractStructBase
{
    /**
     * The parentId
    ...
    /**
     * Constructor method for RemoveNetworkToSubnetworkLink
     * @uses RemoveNetworkToSubnetworkLink::setParentId()
     * @uses RemoveNetworkToSubnetworkLink::setChildId()
     ...
     * Set parentId value
     * @param string $parentId
     * @return \StructType\RemoveNetworkToSubnetworkLink
     */
