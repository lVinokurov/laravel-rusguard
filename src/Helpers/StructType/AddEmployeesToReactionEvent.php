...
/**
 * This class stands for AddEmployeesToReactionEvent StructType
 * @subpackage Structs
 */
class AddEmployeesToReactionEvent extends AbstractStructBase
{
    /**
     * The eventId
    ...
    /**
     * Constructor method for AddEmployeesToReactionEvent
     * @uses AddEmployeesToReactionEvent::setEventId()
     * @uses AddEmployeesToReactionEvent::setEmployeeIds()
     ...
     * Set eventId value
     * @param string $eventId
     * @return \StructType\AddEmployeesToReactionEvent
     */
