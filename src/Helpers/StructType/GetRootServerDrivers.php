...
/**
 * This class stands for GetRootServerDrivers StructType
 * @subpackage Structs
 */
class GetRootServerDrivers extends AbstractStructBase
{
    /**
     * The serverId
    ...
    /**
     * Constructor method for GetRootServerDrivers
     * @uses GetRootServerDrivers::setServerId()
     ...
     * Set serverId value
     * @param string $serverId
     * @return \StructType\GetRootServerDrivers
     */
