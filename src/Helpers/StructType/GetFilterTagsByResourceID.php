...
/**
 * This class stands for GetFilterTagsByResourceID StructType
 * @subpackage Structs
 */
class GetFilterTagsByResourceID extends AbstractStructBase
{
    /**
     * The resourceID
    ...
    /**
     * Constructor method for GetFilterTagsByResourceID
     * @uses GetFilterTagsByResourceID::setResourceID()
     ...
     * @param string $resourceID
     * @return \StructType\GetFilterTagsByResourceID
     */
