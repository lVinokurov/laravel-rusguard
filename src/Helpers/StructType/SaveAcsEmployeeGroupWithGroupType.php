...
/**
 * This class stands for SaveAcsEmployeeGroupWithGroupType StructType
 * @subpackage Structs
 */
class SaveAcsEmployeeGroupWithGroupType extends AbstractStructBase
{
    /**
     * The id
    ...
    /**
     * Constructor method for SaveAcsEmployeeGroupWithGroupType
     * @uses SaveAcsEmployeeGroupWithGroupType::setId()
     * @uses SaveAcsEmployeeGroupWithGroupType::setName()
     * @uses SaveAcsEmployeeGroupWithGroupType::setComment()
     * @uses SaveAcsEmployeeGroupWithGroupType::setTagIDs()
     * @uses SaveAcsEmployeeGroupWithGroupType::setIsGuestGroup()
     * @uses SaveAcsEmployeeGroupWithGroupType::setGroupCode()
     * @param string $id
     * @param string $name
     ...
     */
    public function __construct(?string $id = null, ?string $name = null, ?string $comment = null, ?\ArrayType\ArrayOfguid $tagIDs = null, ?string $isGuestGroup = null, ?string $groupCode = null)
    {
        $this
            ->setId($id)
            ->setName($name)
     ...
     * Set id value
     * @param string $id
     * @return \StructType\SaveAcsEmployeeGroupWithGroupType
     */
