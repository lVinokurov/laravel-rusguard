...
/**
 * This class stands for RemoveWorkZonesFromReportParameters StructType
 * @subpackage Structs
 */
class RemoveWorkZonesFromReportParameters extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for RemoveWorkZonesFromReportParameters
     * @uses RemoveWorkZonesFromReportParameters::setReportId()
     * @uses RemoveWorkZonesFromReportParameters::setVehicleIds()
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\RemoveWorkZonesFromReportParameters
     */
