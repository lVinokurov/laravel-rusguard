...
/**
 * This class stands for RemoveWorkZoneFromEmployeeGroup StructType
 * @subpackage Structs
 */
class RemoveWorkZoneFromEmployeeGroup extends AbstractStructBase
{
    /**
     * The employeeGroupID
    ...
    /**
     * Constructor method for RemoveWorkZoneFromEmployeeGroup
     * @uses RemoveWorkZoneFromEmployeeGroup::setEmployeeGroupID()
     * @uses RemoveWorkZoneFromEmployeeGroup::setWorkZoneIDs()
     ...
     * @param string $employeeGroupID
     * @return \StructType\RemoveWorkZoneFromEmployeeGroup
     */
