...
/**
 * This class stands for RemoveEmployeeGroupsFromReactionAction StructType
 * @subpackage Structs
 */
class RemoveEmployeeGroupsFromReactionAction extends AbstractStructBase
{
    /**
     * The actionId
    ...
    /**
     * Constructor method for RemoveEmployeeGroupsFromReactionAction
     * @uses RemoveEmployeeGroupsFromReactionAction::setActionId()
     * @uses RemoveEmployeeGroupsFromReactionAction::setEmployeeGroupIds()
     ...
     * Set actionId value
     * @param string $actionId
     * @return \StructType\RemoveEmployeeGroupsFromReactionAction
     */
