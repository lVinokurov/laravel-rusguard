...
/**
 * This class stands for AddField StructType
 * @subpackage Structs
 */
class AddField extends AbstractStructBase
{
    /**
     * The field
    ...
    /**
     * Constructor method for AddField
     * @uses AddField::setField()
