...
/**
 * This class stands for RemoveClaim StructType
 * @subpackage Structs
 */
class RemoveClaim extends AbstractStructBase
{
    /**
     * The claimId
    ...
    /**
     * Constructor method for RemoveClaim
     * @uses RemoveClaim::setClaimId()
