...
/**
 * This class stands for GetAllBranch StructType
 * @subpackage Structs
 */
class GetAllBranch extends AbstractStructBase
{
    /**
     * The pageNumber
    ...
    /**
     * Constructor method for GetAllBranch
     * @uses GetAllBranch::setPageNumber()
     * @uses GetAllBranch::setPageSize()
     * @uses GetAllBranch::setSortedColumn()
     * @uses GetAllBranch::setSortOrder()
     ...
     * @param int $pageNumber
     * @return \StructType\GetAllBranch
     */
     ...
     * @uses \EnumType\BranchSortedColumn::valueIsValid()
     * @uses \EnumType\BranchSortedColumn::getValidValues()
    ...
    public function setSortedColumn(?string $sortedColumn = null): self
    {
        ...
        if (!\EnumType\BranchSortedColumn::valueIsValid($sortedColumn)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \EnumType\BranchSortedColumn', is_array($sortedColumn) ? implode(', ', $sortedColumn) : var_export($sortedColumn, true), implode(', ', \EnumType\BranchSortedColumn::getValidValues())), __LINE__);
        }
