...
/**
 * This class stands for RemoveEmployeeSchedule StructType
 * @subpackage Structs
 */
class RemoveEmployeeSchedule extends AbstractStructBase
{
    /**
     * The ids
    ...
    /**
     * Constructor method for RemoveEmployeeSchedule
     * @uses RemoveEmployeeSchedule::setIds()
     * @uses RemoveEmployeeSchedule::setPartOfCreateOperation()
     ...
     * @param \ArrayType\ArrayOfguid $ids
     * @return \StructType\RemoveEmployeeSchedule
     */
