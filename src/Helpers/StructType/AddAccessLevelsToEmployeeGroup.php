...
/**
 * This class stands for AddAccessLevelsToEmployeeGroup StructType
 * @subpackage Structs
 */
class AddAccessLevelsToEmployeeGroup extends AbstractStructBase
{
    /**
     * The employeeGroupID
    ...
    /**
     * Constructor method for AddAccessLevelsToEmployeeGroup
     * @uses AddAccessLevelsToEmployeeGroup::setEmployeeGroupID()
     * @uses AddAccessLevelsToEmployeeGroup::setAccessLevelIDs()
     ...
     * @param string $employeeGroupID
     * @return \StructType\AddAccessLevelsToEmployeeGroup
     */
