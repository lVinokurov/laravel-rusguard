...
/**
 * This class stands for GetSystematicViolation StructType
 * @subpackage Structs
 */
class GetSystematicViolation extends AbstractStructBase
{
    /**
     * The userId
    ...
    /**
     * Constructor method for GetSystematicViolation
     * @uses GetSystematicViolation::setUserId()
     * @param string $userId
     */
     ...
     * Set userId value
     * @param string $userId
     * @return \StructType\GetSystematicViolation
     */
