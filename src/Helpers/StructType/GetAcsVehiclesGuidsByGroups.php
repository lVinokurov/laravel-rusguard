...
/**
 * This class stands for GetAcsVehiclesGuidsByGroups StructType
 * @subpackage Structs
 */
class GetAcsVehiclesGuidsByGroups extends AbstractStructBase
{
    /**
     * The groupIds
    ...
    /**
     * Constructor method for GetAcsVehiclesGuidsByGroups
     * @uses GetAcsVehiclesGuidsByGroups::setGroupIds()
     * @uses GetAcsVehiclesGuidsByGroups::setIsShowRemoved()
     ...
     * @param \ArrayType\ArrayOfguid $groupIds
     * @return \StructType\GetAcsVehiclesGuidsByGroups
     */
