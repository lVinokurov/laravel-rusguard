...
/**
 * This class stands for RemoveSwitchedOffLogDriversFromWorkplace StructType
 * @subpackage Structs
 */
class RemoveSwitchedOffLogDriversFromWorkplace extends AbstractStructBase
{
    /**
     * The workplaceId
    ...
    /**
     * Constructor method for RemoveSwitchedOffLogDriversFromWorkplace
     * @uses RemoveSwitchedOffLogDriversFromWorkplace::setWorkplaceId()
     * @uses RemoveSwitchedOffLogDriversFromWorkplace::setDriverIds()
     ...
     * @param string $workplaceId
     * @return \StructType\RemoveSwitchedOffLogDriversFromWorkplace
     */
