...
/**
 * This class stands for BroadcastFindLanConverters StructType
 * @subpackage Structs
 */
class BroadcastFindLanConverters extends AbstractStructBase
{
    /**
     * The deviceServerId
    ...
    /**
     * Constructor method for BroadcastFindLanConverters
     * @uses BroadcastFindLanConverters::setDeviceServerId()
     ...
     * @param string $deviceServerId
     * @return \StructType\BroadcastFindLanConverters
     */
