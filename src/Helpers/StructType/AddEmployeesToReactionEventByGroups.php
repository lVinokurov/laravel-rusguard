...
/**
 * This class stands for AddEmployeesToReactionEventByGroups StructType
 * @subpackage Structs
 */
class AddEmployeesToReactionEventByGroups extends AbstractStructBase
{
    /**
     * The eventId
    ...
    /**
     * Constructor method for AddEmployeesToReactionEventByGroups
     * @uses AddEmployeesToReactionEventByGroups::setEventId()
     * @uses AddEmployeesToReactionEventByGroups::setEmployeeGroupIds()
     ...
     * Set eventId value
     * @param string $eventId
     * @return \StructType\AddEmployeesToReactionEventByGroups
     */
