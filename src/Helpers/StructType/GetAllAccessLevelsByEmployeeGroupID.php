...
/**
 * This class stands for GetAllAccessLevelsByEmployeeGroupID StructType
 * @subpackage Structs
 */
class GetAllAccessLevelsByEmployeeGroupID extends AbstractStructBase
{
    /**
     * The employeeGroupID
    ...
    /**
     * Constructor method for GetAllAccessLevelsByEmployeeGroupID
     * @uses GetAllAccessLevelsByEmployeeGroupID::setEmployeeGroupID()
     * @uses GetAllAccessLevelsByEmployeeGroupID::setPageNumber()
     * @uses GetAllAccessLevelsByEmployeeGroupID::setPageSize()
     * @uses GetAllAccessLevelsByEmployeeGroupID::setSortedColumn()
     * @uses GetAllAccessLevelsByEmployeeGroupID::setSortOrder()
     * @uses GetAllAccessLevelsByEmployeeGroupID::setAccessLevelsOwner()
     ...
     * @param string $employeeGroupID
     * @return \StructType\GetAllAccessLevelsByEmployeeGroupID
     */
