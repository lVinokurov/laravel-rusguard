...
/**
 * This class stands for LoadNUUOConfiguration StructType
 * @subpackage Structs
 */
class LoadNUUOConfiguration extends AbstractStructBase
{
    /**
     * The deviceServerId
    ...
    /**
     * Constructor method for LoadNUUOConfiguration
     * @uses LoadNUUOConfiguration::setDeviceServerId()
     * @uses LoadNUUOConfiguration::setIp()
     * @uses LoadNUUOConfiguration::setLogin()
     * @uses LoadNUUOConfiguration::setPassword()
     * @uses LoadNUUOConfiguration::setPort()
     ...
     * @param int $port
     */
    public function __construct(?string $deviceServerId = null, ?string $ip = null, ?string $login = null, ?string $password = null, ?int $port = null)
    {
        $this
     ...
     * @param string $deviceServerId
     * @return \StructType\LoadNUUOConfiguration
     */
