...
/**
 * This class stands for GetEmployeeFacesFull StructType
 * @subpackage Structs
 */
class GetEmployeeFacesFull extends AbstractStructBase
{
    /**
     * The employeeId
    ...
    /**
     * Constructor method for GetEmployeeFacesFull
     * @uses GetEmployeeFacesFull::setEmployeeId()
     ...
     * @param string $employeeId
     * @return \StructType\GetEmployeeFacesFull
     */
