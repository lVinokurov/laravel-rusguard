...
/**
 * This class stands for GetTagsByBoxAccessLevelID StructType
 * @subpackage Structs
 */
class GetTagsByBoxAccessLevelID extends AbstractStructBase
{
    /**
     * The accessLevelID
    ...
    /**
     * Constructor method for GetTagsByBoxAccessLevelID
     * @uses GetTagsByBoxAccessLevelID::setAccessLevelID()
     ...
     * @param string $accessLevelID
     * @return \StructType\GetTagsByBoxAccessLevelID
     */
