...
/**
 * This class stands for RemoveWorkSchedules StructType
 * @subpackage Structs
 */
class RemoveWorkSchedules extends AbstractStructBase
{
    /**
     * The ids
    ...
    /**
     * Constructor method for RemoveWorkSchedules
     * @uses RemoveWorkSchedules::setIds()
     ...
     * @param \ArrayType\ArrayOfguid $ids
     * @return \StructType\RemoveWorkSchedules
     */
