...
/**
 * This class stands for RemoveIncidentTemplate StructType
 * @subpackage Structs
 */
class RemoveIncidentTemplate extends AbstractStructBase
{
    /**
     * The ids
    ...
    /**
     * Constructor method for RemoveIncidentTemplate
     * @uses RemoveIncidentTemplate::setIds()
     ...
     * @param \ArrayType\ArrayOfguid $ids
     * @return \StructType\RemoveIncidentTemplate
     */
