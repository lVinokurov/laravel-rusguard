...
/**
 * This class stands for SetUseEmployeeGroupParentWorkSchedule StructType
 * @subpackage Structs
 */
class SetUseEmployeeGroupParentWorkSchedule extends AbstractStructBase
{
    /**
     * The employeeGroupID
    ...
    /**
     * Constructor method for SetUseEmployeeGroupParentWorkSchedule
     * @uses SetUseEmployeeGroupParentWorkSchedule::setEmployeeGroupID()
     * @uses SetUseEmployeeGroupParentWorkSchedule::setIsUseParentWorkSchedule()
     * @uses SetUseEmployeeGroupParentWorkSchedule::setPartOfCreateOperation()
     * @param string $employeeGroupID
     * @param bool $isUseParentWorkSchedule
     * @param bool $partOfCreateOperation
     */
    public function __construct(?string $employeeGroupID = null, ?bool $isUseParentWorkSchedule = null, ?bool $partOfCreateOperation = null)
    {
        $this
     ...
     * @param string $employeeGroupID
     * @return \StructType\SetUseEmployeeGroupParentWorkSchedule
     */
