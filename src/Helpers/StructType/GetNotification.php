...
/**
 * This class stands for GetNotification StructType
 * @subpackage Structs
 */
class GetNotification extends AbstractStructBase
{
    /**
     * The connectionId
    ...
    /**
     * Constructor method for GetNotification
     * @uses GetNotification::setConnectionId()
     ...
     * @param string $connectionId
     * @return \StructType\GetNotification
     */
