...
/**
 * This class stands for GetEmployeePositions StructType
 * @subpackage Structs
 */
class GetEmployeePositions extends AbstractStructBase
{
    /**
     * The pageNumber
    ...
    /**
     * Constructor method for GetEmployeePositions
     * @uses GetEmployeePositions::setPageNumber()
     * @uses GetEmployeePositions::setPageSize()
     * @uses GetEmployeePositions::setSortedColumn()
     * @uses GetEmployeePositions::setSortOrder()
     ...
     * @param int $pageNumber
     * @return \StructType\GetEmployeePositions
     */
