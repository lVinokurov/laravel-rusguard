...
/**
 * This class stands for GetEmployeeFaces StructType
 * @subpackage Structs
 */
class GetEmployeeFaces extends AbstractStructBase
{
    /**
     * The employeeId
    ...
    /**
     * Constructor method for GetEmployeeFaces
     * @uses GetEmployeeFaces::setEmployeeId()
     ...
     * @param string $employeeId
     * @return \StructType\GetEmployeeFaces
     */
