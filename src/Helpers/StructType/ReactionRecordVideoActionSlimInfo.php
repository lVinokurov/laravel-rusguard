...
/**
 * This class stands for ReactionRecordVideoActionSlimInfo StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:ReactionRecordVideoActionSlimInfo
 * @subpackage Structs
 */
class ReactionRecordVideoActionSlimInfo extends ReactionRecordVideoActionSaveData
{
    /**
     * The CommonData
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for ReactionRecordVideoActionSlimInfo
     * @uses ReactionRecordVideoActionSlimInfo::setCommonData()
     ...
     * @param \StructType\ReactionActionSlimInfo $commonData
     * @return \StructType\ReactionRecordVideoActionSlimInfo
     */
