...
/**
 * This class stands for StringField StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:StringField
 * @subpackage Structs
 */
class StringField extends AdditionalFieldBase
{
    /**
     * The DefaultValue
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for StringField
     * @uses StringField::setDefaultValue()
