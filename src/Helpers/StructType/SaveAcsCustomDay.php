...
/**
 * This class stands for SaveAcsCustomDay StructType
 * @subpackage Structs
 */
class SaveAcsCustomDay extends AbstractStructBase
{
    /**
     * The id
    ...
    /**
     * Constructor method for SaveAcsCustomDay
     * @uses SaveAcsCustomDay::setId()
     * @uses SaveAcsCustomDay::setName()
     * @uses SaveAcsCustomDay::setDate()
     * @uses SaveAcsCustomDay::setDayType()
     * @param string $id
     * @param string $name
     * @param string $date
     * @param string $dayType
     */
    public function __construct(?string $id = null, ?string $name = null, ?string $date = null, ?string $dayType = null)
    {
        $this
            ->setId($id)
            ->setName($name)
     ...
     * Set id value
     * @param string $id
     * @return \StructType\SaveAcsCustomDay
     */
