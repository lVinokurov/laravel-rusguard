...
/**
 * This class stands for GetWorkZonesByDriverID StructType
 * @subpackage Structs
 */
class GetWorkZonesByDriverID extends AbstractStructBase
{
    /**
     * The driverID
    ...
    /**
     * Constructor method for GetWorkZonesByDriverID
     * @uses GetWorkZonesByDriverID::setDriverID()
     ...
     * Set driverID value
     * @param string $driverID
     * @return \StructType\GetWorkZonesByDriverID
     */
