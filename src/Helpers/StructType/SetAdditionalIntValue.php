...
/**
 * This class stands for SetAdditionalIntValue StructType
 * @subpackage Structs
 */
class SetAdditionalIntValue extends AbstractStructBase
{
    /**
     * The ownerId
    ...
    /**
     * Constructor method for SetAdditionalIntValue
     * @uses SetAdditionalIntValue::setOwnerId()
     * @uses SetAdditionalIntValue::setFieldId()
     * @uses SetAdditionalIntValue::setValue()
     * @uses SetAdditionalIntValue::setPartOfCreateOperation()
     * @uses SetAdditionalIntValue::setSavedFieldContext()
     ...
     */
    public function __construct(?string $ownerId = null, ?string $fieldId = null, ?int $value = null, ?bool $partOfCreateOperation = null, $savedFieldContext = [])
    {
        $this
            ->setOwnerId($ownerId)
            ->setFieldId($fieldId)
     ...
     * Set ownerId value
     * @param string $ownerId
     * @return \StructType\SetAdditionalIntValue
     */
    ...
    public static function validateSavedFieldContextForArrayConstraintsFromSetSavedFieldContext(array $values = []): string
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $setAdditionalIntValueSavedFieldContextItem) {
            // validation for constraint: enumeration
            if (!\EnumType\SavedFieldContext::valueIsValid($setAdditionalIntValueSavedFieldContextItem)) {
                $invalidValues[] = is_object($setAdditionalIntValueSavedFieldContextItem) ? get_class($setAdditionalIntValueSavedFieldContextItem) : sprintf('%s(%s)', gettype($setAdditionalIntValueSavedFieldContextItem), var_export($setAdditionalIntValueSavedFieldContextItem, true));
            }
        }
