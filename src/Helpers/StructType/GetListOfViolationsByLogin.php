...
/**
 * This class stands for GetListOfViolationsByLogin StructType
 * @subpackage Structs
 */
class GetListOfViolationsByLogin extends AbstractStructBase
{
    /**
     * The login
    ...
    /**
     * Constructor method for GetListOfViolationsByLogin
     * @uses GetListOfViolationsByLogin::setLogin()
     * @uses GetListOfViolationsByLogin::setDepartmentsIds()
     * @uses GetListOfViolationsByLogin::setStartedOn()
     * @uses GetListOfViolationsByLogin::setEndedOn()
     * @uses GetListOfViolationsByLogin::setType()
     * @param string $login
     ...
     * @param string $login
     * @return \StructType\GetListOfViolationsByLogin
     */
