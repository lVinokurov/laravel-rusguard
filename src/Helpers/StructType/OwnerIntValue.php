...
/**
 * This class stands for OwnerIntValue StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:OwnerIntValue
 * @subpackage Structs
 */
class OwnerIntValue extends OwnerValueBase
{
    /**
     * The Value
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for OwnerIntValue
     * @uses OwnerIntValue::setValue()
     * @param int $value
     */
     ...
     * @param int $value
     * @return \StructType\OwnerIntValue
     */
