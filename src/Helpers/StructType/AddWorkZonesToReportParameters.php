...
/**
 * This class stands for AddWorkZonesToReportParameters StructType
 * @subpackage Structs
 */
class AddWorkZonesToReportParameters extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for AddWorkZonesToReportParameters
     * @uses AddWorkZonesToReportParameters::setReportId()
     * @uses AddWorkZonesToReportParameters::setWorkZoneIds()
     * @param string $reportId
     * @param \ArrayType\ArrayOfguid $workZoneIds
     */
    public function __construct(?string $reportId = null, ?\ArrayType\ArrayOfguid $workZoneIds = null)
    {
        $this
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\AddWorkZonesToReportParameters
     */
