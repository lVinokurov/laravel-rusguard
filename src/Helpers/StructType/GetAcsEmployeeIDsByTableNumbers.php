...
/**
 * This class stands for GetAcsEmployeeIDsByTableNumbers StructType
 * @subpackage Structs
 */
class GetAcsEmployeeIDsByTableNumbers extends AbstractStructBase
{
    /**
     * The tableNumbers
    ...
    /**
     * Constructor method for GetAcsEmployeeIDsByTableNumbers
     * @uses GetAcsEmployeeIDsByTableNumbers::setTableNumbers()
     ...
     * @param \ArrayType\ArrayOfint $tableNumbers
     * @return \StructType\GetAcsEmployeeIDsByTableNumbers
     */
