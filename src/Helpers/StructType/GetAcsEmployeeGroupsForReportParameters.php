...
/**
 * This class stands for GetAcsEmployeeGroupsForReportParameters StructType
 * @subpackage Structs
 */
class GetAcsEmployeeGroupsForReportParameters extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for GetAcsEmployeeGroupsForReportParameters
     * @uses GetAcsEmployeeGroupsForReportParameters::setReportId()
     * @uses GetAcsEmployeeGroupsForReportParameters::setIsShowRemoved()
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\GetAcsEmployeeGroupsForReportParameters
     */
