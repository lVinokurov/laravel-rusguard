...
/**
 * This class stands for AddEmployeesToReactionAction StructType
 * @subpackage Structs
 */
class AddEmployeesToReactionAction extends AbstractStructBase
{
    /**
     * The actionId
    ...
    /**
     * Constructor method for AddEmployeesToReactionAction
     * @uses AddEmployeesToReactionAction::setActionId()
     * @uses AddEmployeesToReactionAction::setEmployeeIds()
     ...
     * Set actionId value
     * @param string $actionId
     * @return \StructType\AddEmployeesToReactionAction
     */
