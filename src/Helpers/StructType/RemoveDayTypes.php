...
/**
 * This class stands for RemoveDayTypes StructType
 * @subpackage Structs
 */
class RemoveDayTypes extends AbstractStructBase
{
    /**
     * The ids
    ...
    /**
     * Constructor method for RemoveDayTypes
     * @uses RemoveDayTypes::setIds()
     ...
     * @param \ArrayType\ArrayOfguid $ids
     * @return \StructType\RemoveDayTypes
     */
