...
/**
 * This class stands for SecurityGroupDictionaryElementSaveInfo StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:SecurityGroupDictionaryElementSaveInfo
 * @subpackage Structs
 */
class SecurityGroupDictionaryElementSaveInfo extends DictionaryElementSaveInfo
{
    /**
     * The ParentID
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for SecurityGroupDictionaryElementSaveInfo
     * @uses SecurityGroupDictionaryElementSaveInfo::setParentID()
     ...
     * @param string $parentID
     * @return \StructType\SecurityGroupDictionaryElementSaveInfo
     */
