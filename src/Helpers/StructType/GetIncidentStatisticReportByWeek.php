...
/**
 * This class stands for GetIncidentStatisticReportByWeek StructType
 * @subpackage Structs
 */
class GetIncidentStatisticReportByWeek extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for GetIncidentStatisticReportByWeek
     * @uses GetIncidentStatisticReportByWeek::setIncidentStatisticData()
     * @uses GetIncidentStatisticReportByWeek::setExtension()
     ...
     * @param \StructType\IncidentStatisticData $incidentStatisticData
     * @return \StructType\GetIncidentStatisticReportByWeek
     */
