...
/**
 * This class stands for UpdateSecurOSConfiguration StructType
 * @subpackage Structs
 */
class UpdateSecurOSConfiguration extends AbstractStructBase
{
    /**
     * The iidkId
    ...
    /**
     * Constructor method for UpdateSecurOSConfiguration
     * @uses UpdateSecurOSConfiguration::setIidkId()
     * @param string $iidkId
     */
     ...
     * Set iidkId value
     * @param string $iidkId
     * @return \StructType\UpdateSecurOSConfiguration
     */
