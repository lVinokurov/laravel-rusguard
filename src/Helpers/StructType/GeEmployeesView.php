...
/**
 * This class stands for GeEmployeesView StructType
 * @subpackage Structs
 */
class GeEmployeesView extends AbstractStructBase
{
    /**
     * The ids
    ...
    /**
     * Constructor method for GeEmployeesView
     * @uses GeEmployeesView::setIds()
     ...
     * @param \ArrayType\ArrayOfguid $ids
     * @return \StructType\GeEmployeesView
     */
