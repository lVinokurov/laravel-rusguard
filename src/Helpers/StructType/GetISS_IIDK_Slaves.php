...
/**
 * This class stands for GetISS_IIDK_Slaves StructType
 * @subpackage Structs
 */
class GetISS_IIDK_Slaves extends AbstractStructBase
{
    /**
     * The iidkId
    ...
    /**
     * Constructor method for GetISS_IIDK_Slaves
     * @uses GetISS_IIDK_Slaves::setIidkId()
     * @param string $iidkId
     */
     ...
     * Set iidkId value
     * @param string $iidkId
     * @return \StructType\GetISS_IIDK_Slaves
     */
