...
/**
 * This class stands for SavePhoneNumber StructType
 * @subpackage Structs
 */
class SavePhoneNumber extends AbstractStructBase
{
    /**
     * The id
    ...
    /**
     * Constructor method for SavePhoneNumber
     * @uses SavePhoneNumber::setId()
     * @uses SavePhoneNumber::setData()
     * @uses SavePhoneNumber::setPartOfCreateOperation()
     * @param string $id
     * @param \StructType\PhoneNumberSaveData $data
     * @param bool $partOfCreateOperation
     */
    public function __construct(?string $id = null, ?\StructType\PhoneNumberSaveData $data = null, ?bool $partOfCreateOperation = null)
    {
        $this
            ->setId($id)
            ->setData($data)
     ...
     * Set id value
     * @param string $id
     * @return \StructType\SavePhoneNumber
     */
