...
class GetEvents extends AbstractStructBase
{
     ...
     * @uses GetEvents::setFromMessageId()
     * @uses GetEvents::setFromDateTime()
     * @uses GetEvents::setToDateTime()
     * @uses GetEvents::setMsgTypes()
     * @uses GetEvents::setMsgSubTypes()
     * @uses GetEvents::setSubjectIDs()
     * @uses GetEvents::setSubjectType()
     * @uses GetEvents::setPageNumber()
     * @uses GetEvents::setPageSize()
     * @uses GetEvents::setSortedColumn()
     * @uses GetEvents::setSortOrder()
     ...
     */
    public function __construct(?int $fromMessageId = null, ?string $fromDateTime = null, ?string $toDateTime = null, ?\ArrayType\ArrayOfLogMsgType $msgTypes = null, ?\ArrayType\ArrayOfLogMsgSubType $msgSubTypes = null, ?\ArrayType\ArrayOfguid $subjectIDs = null, ?string $subjectType = null, ?int $pageNumber = null, ?int $pageSize = null, ?string $sortedColumn = null, ?string $sortOrder = null)
    {
        $this
