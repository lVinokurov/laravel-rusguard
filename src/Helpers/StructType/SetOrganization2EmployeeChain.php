...
/**
 * This class stands for SetOrganization2EmployeeChain StructType
 * @subpackage Structs
 */
class SetOrganization2EmployeeChain extends AbstractStructBase
{
    /**
     * The employeeId
    ...
    /**
     * Constructor method for SetOrganization2EmployeeChain
     * @uses SetOrganization2EmployeeChain::setEmployeeId()
     * @uses SetOrganization2EmployeeChain::setOrganizationAssignments()
     * @param string $employeeId
     * @param \ArrayType\ArrayOfEmployee2OrganizationAssignment $organizationAssignments
     */
    public function __construct(?string $employeeId = null, ?\ArrayType\ArrayOfEmployee2OrganizationAssignment $organizationAssignments = null)
    {
        $this
     ...
     * @param string $employeeId
     * @return \StructType\SetOrganization2EmployeeChain
     */
