...
/**
 * This class stands for SetStatusOfAcsKeyAsClear StructType
 * @subpackage Structs
 */
class SetStatusOfAcsKeyAsClear extends AbstractStructBase
{
    /**
     * The keyNumber
    ...
    /**
     * Constructor method for SetStatusOfAcsKeyAsClear
     * @uses SetStatusOfAcsKeyAsClear::setKeyNumber()
     * @uses SetStatusOfAcsKeyAsClear::setEmployeeID()
     * @uses SetStatusOfAcsKeyAsClear::setPartOfCreateOperation()
     * @param int $keyNumber
     * @param string $employeeID
     * @param bool $partOfCreateOperation
     */
    public function __construct(?int $keyNumber = null, ?string $employeeID = null, ?bool $partOfCreateOperation = null)
    {
        $this
     ...
     * Set keyNumber value
     * @param int $keyNumber
     * @return \StructType\SetStatusOfAcsKeyAsClear
     */
