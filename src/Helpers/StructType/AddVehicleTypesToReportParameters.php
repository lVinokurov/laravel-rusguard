...
/**
 * This class stands for AddVehicleTypesToReportParameters StructType
 * @subpackage Structs
 */
class AddVehicleTypesToReportParameters extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for AddVehicleTypesToReportParameters
     * @uses AddVehicleTypesToReportParameters::setReportId()
     * @uses AddVehicleTypesToReportParameters::setVehicleIds()
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\AddVehicleTypesToReportParameters
     */
