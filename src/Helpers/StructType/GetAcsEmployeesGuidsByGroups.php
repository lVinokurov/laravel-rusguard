...
/**
 * This class stands for GetAcsEmployeesGuidsByGroups StructType
 * @subpackage Structs
 */
class GetAcsEmployeesGuidsByGroups extends AbstractStructBase
{
    /**
     * The groupIds
    ...
    /**
     * Constructor method for GetAcsEmployeesGuidsByGroups
     * @uses GetAcsEmployeesGuidsByGroups::setGroupIds()
     * @uses GetAcsEmployeesGuidsByGroups::setIsShowRemoved()
     ...
     * @param \ArrayType\ArrayOfguid $groupIds
     * @return \StructType\GetAcsEmployeesGuidsByGroups
     */
