...
/**
 * This class stands for GetAcsAccessPoints StructType
 * @subpackage Structs
 */
class GetAcsAccessPoints extends AbstractStructBase
{
    /**
     * The accessLevelId
    ...
    /**
     * Constructor method for GetAcsAccessPoints
     * @uses GetAcsAccessPoints::setAccessLevelId()
     ...
     * @param string $accessLevelId
     * @return \StructType\GetAcsAccessPoints
     */
