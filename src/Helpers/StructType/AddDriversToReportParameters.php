...
/**
 * This class stands for AddDriversToReportParameters StructType
 * @subpackage Structs
 */
class AddDriversToReportParameters extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for AddDriversToReportParameters
     * @uses AddDriversToReportParameters::setReportId()
     * @uses AddDriversToReportParameters::setDriverIds()
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\AddDriversToReportParameters
     */
