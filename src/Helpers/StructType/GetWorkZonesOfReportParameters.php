...
/**
 * This class stands for GetWorkZonesOfReportParameters StructType
 * @subpackage Structs
 */
class GetWorkZonesOfReportParameters extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for GetWorkZonesOfReportParameters
     * @uses GetWorkZonesOfReportParameters::setReportId()
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\GetWorkZonesOfReportParameters
     */
