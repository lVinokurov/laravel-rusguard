...
/**
 * This class stands for SaveAlcoGroup StructType
 * @subpackage Structs
 */
class SaveAlcoGroup extends AbstractStructBase
{
    /**
     * The id
    ...
    /**
     * Constructor method for SaveAlcoGroup
     * @uses SaveAlcoGroup::setId()
     * @uses SaveAlcoGroup::setData()
     * @param string $id
     * @param \StructType\AcsAlcoGroupSaveData $data
     */
    public function __construct(?string $id = null, ?\StructType\AcsAlcoGroupSaveData $data = null)
    {
        $this
            ->setId($id)
            ->setData($data);
     ...
     * Set id value
     * @param string $id
     * @return \StructType\SaveAlcoGroup
     */
