...
/**
 * This class stands for GetVehiclesOfReportParameters StructType
 * @subpackage Structs
 */
class GetVehiclesOfReportParameters extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for GetVehiclesOfReportParameters
     * @uses GetVehiclesOfReportParameters::setReportId()
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\GetVehiclesOfReportParameters
     */
