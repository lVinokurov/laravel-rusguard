...
/**
 * This class stands for GetCardTypes StructType
 * @subpackage Structs
 */
class GetCardTypes extends AbstractStructBase
{
     ...
     * @uses GetCardTypes::setPageNumber()
     * @uses GetCardTypes::setPageSize()
     * @uses GetCardTypes::setSortedColumn()
     * @uses GetCardTypes::setSortOrder()
     ...
     * @param int $pageNumber
     * @return \StructType\GetCardTypes
     */
     ...
     * @uses \EnumType\CardTypeSortedColumn::valueIsValid()
     * @uses \EnumType\CardTypeSortedColumn::getValidValues()
    ...
    public function setSortedColumn(?string $sortedColumn = null): self
    {
        ...
        if (!\EnumType\CardTypeSortedColumn::valueIsValid($sortedColumn)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \EnumType\CardTypeSortedColumn', is_array($sortedColumn) ? implode(', ', $sortedColumn) : var_export($sortedColumn, true), implode(', ', \EnumType\CardTypeSortedColumn::getValidValues())), __LINE__);
        }
