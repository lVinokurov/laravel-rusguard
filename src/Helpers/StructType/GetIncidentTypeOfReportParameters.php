...
/**
 * This class stands for GetIncidentTypeOfReportParameters StructType
 * @subpackage Structs
 */
class GetIncidentTypeOfReportParameters extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for GetIncidentTypeOfReportParameters
     * @uses GetIncidentTypeOfReportParameters::setReportId()
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\GetIncidentTypeOfReportParameters
     */
