...
/**
 * This class stands for RemoveISS_Recognition StructType
 * @subpackage Structs
 */
class RemoveISS_Recognition extends AbstractStructBase
{
    /**
     * The ids
    ...
    /**
     * Constructor method for RemoveISS_Recognition
     * @uses RemoveISS_Recognition::setIds()
     ...
     * @param \ArrayType\ArrayOfguid $ids
     * @return \StructType\RemoveISS_Recognition
     */
