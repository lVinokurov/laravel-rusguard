...
/**
 * This class stands for RemoveLogMessageSubtypesFromReactionEvent StructType
 * @subpackage Structs
 */
class RemoveLogMessageSubtypesFromReactionEvent extends AbstractStructBase
{
    /**
     * The eventId
    ...
    /**
     * Constructor method for RemoveLogMessageSubtypesFromReactionEvent
     * @uses RemoveLogMessageSubtypesFromReactionEvent::setEventId()
     * @uses RemoveLogMessageSubtypesFromReactionEvent::setSubtypes()
     ...
     * Set eventId value
     * @param string $eventId
     * @return \StructType\RemoveLogMessageSubtypesFromReactionEvent
     */
