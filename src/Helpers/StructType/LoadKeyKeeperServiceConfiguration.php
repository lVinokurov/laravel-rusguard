...
/**
 * This class stands for LoadKeyKeeperServiceConfiguration StructType
 * @subpackage Structs
 */
class LoadKeyKeeperServiceConfiguration extends AbstractStructBase
{
    /**
     * The deviceServerId
    ...
    /**
     * Constructor method for LoadKeyKeeperServiceConfiguration
     * @uses LoadKeyKeeperServiceConfiguration::setDeviceServerId()
     * @uses LoadKeyKeeperServiceConfiguration::setIp()
     * @uses LoadKeyKeeperServiceConfiguration::setLogin()
     * @uses LoadKeyKeeperServiceConfiguration::setPassword()
     ...
     * @param string $deviceServerId
     * @return \StructType\LoadKeyKeeperServiceConfiguration
     */
