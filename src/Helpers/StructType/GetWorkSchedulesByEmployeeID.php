...
/**
 * This class stands for GetWorkSchedulesByEmployeeID StructType
 * @subpackage Structs
 */
class GetWorkSchedulesByEmployeeID extends AbstractStructBase
{
    /**
     * The employeeID
    ...
    /**
     * Constructor method for GetWorkSchedulesByEmployeeID
     * @uses GetWorkSchedulesByEmployeeID::setEmployeeID()
     * @uses GetWorkSchedulesByEmployeeID::setPageNumber()
     * @uses GetWorkSchedulesByEmployeeID::setPageSize()
     * @uses GetWorkSchedulesByEmployeeID::setSortedColumn()
     * @uses GetWorkSchedulesByEmployeeID::setSortOrder()
     * @uses GetWorkSchedulesByEmployeeID::setWorkSchedulesOwner()
     ...
     */
    public function __construct(?string $employeeID = null, ?int $pageNumber = null, ?int $pageSize = null, ?string $sortedColumn = null, ?string $sortOrder = null, ?string $workSchedulesOwner = null)
    {
        $this
     ...
     * @param string $employeeID
     * @return \StructType\GetWorkSchedulesByEmployeeID
     */
