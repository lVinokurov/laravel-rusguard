...
/**
 * This class stands for ReactionSendSMSActionSlimInfo StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:ReactionSendSMSActionSlimInfo
 * @subpackage Structs
 */
class ReactionSendSMSActionSlimInfo extends ReactionSendSMSActionSaveData
{
    /**
     * The CommonData
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for ReactionSendSMSActionSlimInfo
     * @uses ReactionSendSMSActionSlimInfo::setCommonData()
     ...
     * @param \StructType\ReactionActionSlimInfo $commonData
     * @return \StructType\ReactionSendSMSActionSlimInfo
     */
