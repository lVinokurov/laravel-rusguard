...
/**
 * This class stands for GetFilteredEvents StructType
 * @subpackage Structs
 */
class GetFilteredEvents extends AbstractStructBase
{
    /**
     * The fromMessageId
     ...
     * @var \ArrayType\ArrayOfguid|null
     */
    protected ?\ArrayType\ArrayOfguid $subjectIDs2 = null;
    /**
     * The subjectType2
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var string|null
     */
    protected ?string $subjectType2 = null;
    /**
     * The isShowRemovedEmployes
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var bool|null
     */
    protected ?bool $isShowRemovedEmployes = null;
    /**
     * The isEmptyConsider
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var bool|null
     */
    protected ?bool $isEmptyConsider = null;
    /**
     * The isReturnLogCount
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var bool|null
     */
    protected ?bool $isReturnLogCount = null;
    /**
     * Constructor method for GetFilteredEvents
     * @uses GetFilteredEvents::setFromMessageId()
     * @uses GetFilteredEvents::setFromDateTime()
     * @uses GetFilteredEvents::setToDateTime()
     * @uses GetFilteredEvents::setMsgTypes()
     * @uses GetFilteredEvents::setMsgSubTypes()
     * @uses GetFilteredEvents::setDeviceIDs()
     * @uses GetFilteredEvents::setSubjectIDs()
     * @uses GetFilteredEvents::setSubjectType()
     * @uses GetFilteredEvents::setPageNumber()
     * @uses GetFilteredEvents::setPageSize()
     * @uses GetFilteredEvents::setSortedColumn()
     * @uses GetFilteredEvents::setSortOrder()
     * @uses GetFilteredEvents::setIsShowEventsWithRelatedData()
     * @uses GetFilteredEvents::setSubjectIDs2()
     * @uses GetFilteredEvents::setSubjectType2()
     * @uses GetFilteredEvents::setIsShowRemovedEmployes()
     * @uses GetFilteredEvents::setIsEmptyConsider()
     * @uses GetFilteredEvents::setIsReturnLogCount()
    ...
    public function __construct(?int $fromMessageId = null, ?string $fromDateTime = null, ?string $toDateTime = null, ?\ArrayType\ArrayOfLogMsgType $msgTypes = null, ?\ArrayType\ArrayOfLogMsgSubType $msgSubTypes = null, ?\ArrayType\ArrayOfguid $deviceIDs = null, ?\ArrayType\ArrayOfguid $subjectIDs = null, ?string $subjectType = null, ?int $pageNumber = null, ?int $pageSize = null, ?string $sortedColumn = null, ?string $sortOrder = null, ?bool $isShowEventsWithRelatedData = null, ?\ArrayType\ArrayOfguid $subjectIDs2 = null, ?string $subjectType2 = null, ?bool $isShowRemovedEmployes = null, ?bool $isEmptyConsider = null, ?bool $isReturnLogCount = null)
    {
        $this
            ...
            ->setSubjectIDs2($subjectIDs2)
            ->setSubjectType2($subjectType2)
            ->setIsShowRemovedEmployes($isShowRemovedEmployes)
            ->setIsEmptyConsider($isEmptyConsider)
            ->setIsReturnLogCount($isReturnLogCount);
    }
    /**
     ...
     * @param int $fromMessageId
     * @return \StructType\GetFilteredEvents
     */
    ...
    /**
     * Get subjectIDs2 value
     * An additional test has been added (isset) before returning the property value as
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \ArrayType\ArrayOfguid|null
     */
    public function getSubjectIDs2(): ?\ArrayType\ArrayOfguid
    {
        return isset($this->subjectIDs2) ? $this->subjectIDs2 : null;
    }
    /**
     * Set subjectIDs2 value
     * This property is removable from request (nillable=true+minOccurs=0), therefore
     * if the value assigned to this property is null, it is removed from this object
     * @param \ArrayType\ArrayOfguid $subjectIDs2
     * @return \StructType\GetFilteredEvents
     */
    public function setSubjectIDs2(?\ArrayType\ArrayOfguid $subjectIDs2 = null): self
    {
        if (is_null($subjectIDs2) || (is_array($subjectIDs2) && empty($subjectIDs2))) {
            unset($this->subjectIDs2);
        } else {
            $this->subjectIDs2 = $subjectIDs2;
        }
        
        return $this;
    }
    /**
     * Get subjectType2 value
     * @return string|null
     */
    public function getSubjectType2(): ?string
    {
        return $this->subjectType2;
    }
    /**
     * Set subjectType2 value
     * @uses \EnumType\LogSubjectType::valueIsValid()
     * @uses \EnumType\LogSubjectType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $subjectType2
     * @return \StructType\GetFilteredEvents
     */
    public function setSubjectType2(?string $subjectType2 = null): self
    {
        // validation for constraint: enumeration
        if (!\EnumType\LogSubjectType::valueIsValid($subjectType2)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \EnumType\LogSubjectType', is_array($subjectType2) ? implode(', ', $subjectType2) : var_export($subjectType2, true), implode(', ', \EnumType\LogSubjectType::getValidValues())), __LINE__);
        }
    ...
    /**
     * Get isShowRemovedEmployes value
     * An additional test has been added (isset) before returning the property value as
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return bool|null
     */
    public function getIsShowRemovedEmployes(): ?bool
    {
        return isset($this->isShowRemovedEmployes) ? $this->isShowRemovedEmployes : null;
    }
    /**
     * Set isShowRemovedEmployes value
     * This property is removable from request (nillable=true+minOccurs=0), therefore
     * if the value assigned to this property is null, it is removed from this object
     * @param bool $isShowRemovedEmployes
     * @return \StructType\GetFilteredEvents
     */
    public function setIsShowRemovedEmployes(?bool $isShowRemovedEmployes = null): self
    {
        // validation for constraint: boolean
        if (!is_null($isShowRemovedEmployes) && !is_bool($isShowRemovedEmployes)) {
            throw new InvalidArgumentException(sprintf('Invalid value %s, please provide a bool, %s given', var_export($isShowRemovedEmployes, true), gettype($isShowRemovedEmployes)), __LINE__);
        }
        if (is_null($isShowRemovedEmployes) || (is_array($isShowRemovedEmployes) && empty($isShowRemovedEmployes))) {
            unset($this->isShowRemovedEmployes);
        } else {
            $this->isShowRemovedEmployes = $isShowRemovedEmployes;
        }
        
        return $this;
    }
    /**
     * Get isEmptyConsider value
     * @return bool|null
     */
    public function getIsEmptyConsider(): ?bool
    {
        return $this->isEmptyConsider;
    }
    /**
     * Set isEmptyConsider value
     * @param bool $isEmptyConsider
     * @return \StructType\GetFilteredEvents
     */
    public function setIsEmptyConsider(?bool $isEmptyConsider = null): self
    {
        // validation for constraint: boolean
        if (!is_null($isEmptyConsider) && !is_bool($isEmptyConsider)) {
            throw new InvalidArgumentException(sprintf('Invalid value %s, please provide a bool, %s given', var_export($isEmptyConsider, true), gettype($isEmptyConsider)), __LINE__);
        }
        $this->isEmptyConsider = $isEmptyConsider;
        
        return $this;
    }
    /**
     * Get isReturnLogCount value
     * @return bool|null
     */
    public function getIsReturnLogCount(): ?bool
    {
        return $this->isReturnLogCount;
    }
    /**
     * Set isReturnLogCount value
     * @param bool $isReturnLogCount
     * @return \StructType\GetFilteredEvents
     */
    public function setIsReturnLogCount(?bool $isReturnLogCount = null): self
    {
        // validation for constraint: boolean
        if (!is_null($isReturnLogCount) && !is_bool($isReturnLogCount)) {
            throw new InvalidArgumentException(sprintf('Invalid value %s, please provide a bool, %s given', var_export($isReturnLogCount, true), gettype($isReturnLogCount)), __LINE__);
        }
        $this->isReturnLogCount = $isReturnLogCount;
