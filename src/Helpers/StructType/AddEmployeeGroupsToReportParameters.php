...
/**
 * This class stands for AddEmployeeGroupsToReportParameters StructType
 * @subpackage Structs
 */
class AddEmployeeGroupsToReportParameters extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for AddEmployeeGroupsToReportParameters
     * @uses AddEmployeeGroupsToReportParameters::setReportId()
     * @uses AddEmployeeGroupsToReportParameters::setEmployeeGroupIds()
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\AddEmployeeGroupsToReportParameters
     */
