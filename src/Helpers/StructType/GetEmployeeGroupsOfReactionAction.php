...
/**
 * This class stands for GetEmployeeGroupsOfReactionAction StructType
 * @subpackage Structs
 */
class GetEmployeeGroupsOfReactionAction extends AbstractStructBase
{
    /**
     * The actionId
    ...
    /**
     * Constructor method for GetEmployeeGroupsOfReactionAction
     * @uses GetEmployeeGroupsOfReactionAction::setActionId()
     ...
     * Set actionId value
     * @param string $actionId
     * @return \StructType\GetEmployeeGroupsOfReactionAction
     */
