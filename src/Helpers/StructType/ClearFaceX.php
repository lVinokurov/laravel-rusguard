...
/**
 * This class stands for ClearFaceX StructType
 * @subpackage Structs
 */
class ClearFaceX extends AbstractStructBase
{
    /**
     * The address
    ...
    /**
     * Constructor method for ClearFaceX
     * @uses ClearFaceX::setAddress()
     * @uses ClearFaceX::setPort()
