...
/**
 * This class stands for GetVehicleForEmployee StructType
 * @subpackage Structs
 */
class GetVehicleForEmployee extends AbstractStructBase
{
    /**
     * The employeeId
    ...
    /**
     * Constructor method for GetVehicleForEmployee
     * @uses GetVehicleForEmployee::setEmployeeId()
     ...
     * @param string $employeeId
     * @return \StructType\GetVehicleForEmployee
     */
