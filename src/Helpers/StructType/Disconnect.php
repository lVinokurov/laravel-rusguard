...
/**
 * This class stands for Disconnect StructType
 * @subpackage Structs
 */
class Disconnect extends AbstractStructBase
{
    /**
     * The connectionId
    ...
    /**
     * Constructor method for Disconnect
     * @uses Disconnect::setConnectionId()
