...
/**
 * This class stands for GeEmployeesViewResult StructType
 * @subpackage Structs
 */
class GeEmployeesViewResult extends AbstractStructBase
{
    /**
     * The schema
    ...
    protected $any = null;
    /**
     * Constructor method for GeEmployeesViewResult
     * @uses GeEmployeesViewResult::setSchema()
     * @uses GeEmployeesViewResult::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument|string|null $schema
     * @return \StructType\GeEmployeesViewResult
     */
