...
/**
 * This class stands for GetOrganizationAssignmentsForEmployee StructType
 * @subpackage Structs
 */
class GetOrganizationAssignmentsForEmployee extends AbstractStructBase
{
    /**
     * The vehicleId
    ...
    /**
     * Constructor method for GetOrganizationAssignmentsForEmployee
     * @uses GetOrganizationAssignmentsForEmployee::setVehicleId()
     ...
     * Set vehicleId value
     * @param string $vehicleId
     * @return \StructType\GetOrganizationAssignmentsForEmployee
     */
