...
/**
 * This class stands for SaveAcsDaySchedule StructType
 * @subpackage Structs
 */
class SaveAcsDaySchedule extends AbstractStructBase
{
    /**
     * The id
    ...
    /**
     * Constructor method for SaveAcsDaySchedule
     * @uses SaveAcsDaySchedule::setId()
     * @uses SaveAcsDaySchedule::setName()
     * @uses SaveAcsDaySchedule::setComment()
     * @uses SaveAcsDaySchedule::setDayIntervals()
     * @param string $id
     * @param string $name
     * @param string $comment
     * @param \StructType\RGDayIntervals $dayIntervals
     */
    public function __construct(?string $id = null, ?string $name = null, ?string $comment = null, ?\StructType\RGDayIntervals $dayIntervals = null)
    {
        $this
            ->setId($id)
            ->setName($name)
     ...
     * Set id value
     * @param string $id
     * @return \StructType\SaveAcsDaySchedule
     */
