...
/**
 * This class stands for RemoveEmployeesFromReactionEvent StructType
 * @subpackage Structs
 */
class RemoveEmployeesFromReactionEvent extends AbstractStructBase
{
    /**
     * The eventId
    ...
    /**
     * Constructor method for RemoveEmployeesFromReactionEvent
     * @uses RemoveEmployeesFromReactionEvent::setEventId()
     * @uses RemoveEmployeesFromReactionEvent::setEmployeeIds()
     * @param string $eventId
     * @param \ArrayType\ArrayOfguid $employeeIds
     */
    public function __construct(?string $eventId = null, ?\ArrayType\ArrayOfguid $employeeIds = null)
    {
        $this
            ->setEventId($eventId)
     ...
     * Set eventId value
     * @param string $eventId
     * @return \StructType\RemoveEmployeesFromReactionEvent
     */
