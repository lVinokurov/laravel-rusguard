...
/**
 * This class stands for GetUserGroups StructType
 * @subpackage Structs
 */
class GetUserGroups extends AbstractStructBase
{
    /**
     * The pageNumber
    ...
    /**
     * Constructor method for GetUserGroups
     * @uses GetUserGroups::setPageNumber()
     * @uses GetUserGroups::setPageSize()
     * @uses GetUserGroups::setSortedColumn()
     * @uses GetUserGroups::setSortOrder()
     ...
     * @param int $pageNumber
     * @return \StructType\GetUserGroups
     */
