...
/**
 * This class stands for GetEmployeesForVehicle StructType
 * @subpackage Structs
 */
class GetEmployeesForVehicle extends AbstractStructBase
{
    /**
     * The vehicleId
    ...
    /**
     * Constructor method for GetEmployeesForVehicle
     * @uses GetEmployeesForVehicle::setVehicleId()
     * @uses GetEmployeesForVehicle::setIncludeRemoved()
     ...
     * Set vehicleId value
     * @param string $vehicleId
     * @return \StructType\GetEmployeesForVehicle
     */
