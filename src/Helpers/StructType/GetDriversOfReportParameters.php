...
/**
 * This class stands for GetDriversOfReportParameters StructType
 * @subpackage Structs
 */
class GetDriversOfReportParameters extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for GetDriversOfReportParameters
     * @uses GetDriversOfReportParameters::setReportId()
     ...
     * Set reportId value
     * @param string $reportId
     * @return \StructType\GetDriversOfReportParameters
     */
