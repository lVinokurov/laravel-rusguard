...
/**
 * This class stands for GetPhoneNumbers StructType
 * @subpackage Structs
 */
class GetPhoneNumbers extends AbstractStructBase
{
    /**
     * The owner
    ...
    /**
     * Constructor method for GetPhoneNumbers
     * @uses GetPhoneNumbers::setOwner()
     * @uses GetPhoneNumbers::setOwnerId()
     * @param string $owner
     ...
     * @param string $owner
     * @return \StructType\GetPhoneNumbers
     */
