...
/**
 * This class stands for ColorField StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:ColorField
 * @subpackage Structs
 */
class ColorField extends AdditionalFieldBase
{
    /**
     * The DefaultValue
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for ColorField
     * @uses ColorField::setDefaultValue()
