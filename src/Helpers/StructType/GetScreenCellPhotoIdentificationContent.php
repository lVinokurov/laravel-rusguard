...
/**
 * This class stands for GetScreenCellPhotoIdentificationContent StructType
 * @subpackage Structs
 */
class GetScreenCellPhotoIdentificationContent extends AbstractStructBase
{
    /**
     * The cellId
    ...
    /**
     * Constructor method for GetScreenCellPhotoIdentificationContent
     * @uses GetScreenCellPhotoIdentificationContent::setCellId()
     * @param string $cellId
     */
     ...
     * Set cellId value
     * @param string $cellId
     * @return \StructType\GetScreenCellPhotoIdentificationContent
     */
